Proceso puntosRumy3Jugadores
		...
		Definir sumaColumna2, sumaColumna3 Como Entero;
		...
		Para i<-0 hasta 9 con paso 1 Hacer
			...
			FinPara
		FinPara
		Escribir "El puntaje del jugador 3 fue: ", sumaColumna3;
		//Condicional que me determina el ganador segun las reglas
		//El que tiene menor cantidad de puntos acumulados gana el juego
		
		Si sumaColumna1 < sumaColumna2 y sumaColumna1 < sumaColumna3 Entonces
			Escribir "Jugador 1 gana";
		sino
			Si sumaColumna1 = sumaColumna2 y sumaColumna1 == sumaColumna3 y sumaColumna2 == sumaColumna3 Entonces
				Escribir "Empate";
			SiNo
				Si sumaColumna1 > sumaColumna2 y sumaColumna3 > sumaColumna2 Entonces
					Escribir "Jugador 2 gana";
				SiNo
					Si sumaColumna3 < sumaColumna1 y sumaColumna3 < sumaColumna2 Entonces
						Escribir "Jugador 3 gana";
					FinSi
				FinSi
			FinSi
		FinSi
